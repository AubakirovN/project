...
class User extends \Core\Model
{
    ...
    public function save()
    {
        ...
        if (empty($this->errors)) {
            ...
            $age = $this->calcAge($this->birth_date);

            $sql = 'INSERT INTO users (name, email, password_hash, activation_hash, birth_date, age, avatar)
                    VALUES (:name, :email, :password_hash, :activation_hash, :birth_date,:age, :avatar)';
    ...
    /**
     * Calculate age by given birth date
     * @param $birthDate
     * @return int
     * @throws \Exception
     */
